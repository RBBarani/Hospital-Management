          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-center p-5">
				...
				?>
                <h6 class="font-weight-bold"><?php echo e(ucfirst($segment)); ?> Login</h6>
                <form method="POST" action="<?php echo e(route($segment.'.login.submit')); ?>">
					<?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\bavithra\RBHospital\resources\views/login.blade.php ENDPATH**/ ?>